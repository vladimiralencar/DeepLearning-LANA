...
vector_a = cl_array.to_device(fila,  np.random.randint(vector_dimension, size=vector_dimension).astype(np.intc))
vector_b = cl_array.to_device(fila,  np.random.randint(vector_dimension, size=vector_dimension).astype(np.intc))  
